...
public class Erase implements Tool
{
	...
	{
		ImageUtils.drawPoints(area.img, new Point[] {new Point(x, y)}, DrawArea.TRANSPARENT);
	...
	public void drag(int x, int y)
	{
		...
		{
			ImageUtils.drawPoints(area.img, ShapeUtils.getLine(area.lastUpdated.x, area.lastUpdated.y, x, y), DrawArea.TRANSPARENT);
