...
import stencyl.ext.polydes.extrasmanager.app.StatusBar;
import stencyl.ext.polydes.extrasmanager.app.UIConsts;
import stencyl.ext.polydes.extrasmanager.app.utils.PopupUtil;
import stencyl.ext.polydes.extrasmanager.app.utils.PopupUtil.PopupItem;
import stencyl.ext.polydes.extrasmanager.app.utils.PopupUtil.PopupSelectionListener;
import stencyl.ext.polydes.extrasmanager.data.folder.Branch;
import stencyl.ext.polydes.extrasmanager.data.folder.LeafWalkUtil;
import stencyl.ext.polydes.extrasmanager.data.folder.LeafWalkUtil.LeafRunnable;
	...
	CellEditorListener, CellEditValidator, HierarchyRepresentation<T>
{
	...
	private static ImageIcon newItemEnabled = Resources.loadIcon("tree/plus-enabled.png");
	private static ImageIcon newItemDisabled = Resources.loadIcon("tree/plus-disabled.png");
	private static ImageIcon newItemPressed = Resources.loadIcon("tree/plus-pressed.png");
	
	private static ImageIcon removeItemEnabled = Resources.loadIcon("tree/minus-enabled.png");
	private static ImageIcon removeItemDisabled = Resources.loadIcon("tree/minus-disabled.png");
	private static ImageIcon removeItemPressed = Resources.loadIcon("tree/minus-pressed.png");

	private static ImageIcon propertiesEnabled = Resources.loadIcon("tree/properties-enabled.png");
	private static ImageIcon propertiesDisabled = Resources.loadIcon("tree/properties-disabled.png");
	private static ImageIcon propertiesPressed = Resources.loadIcon("tree/properties-pressed.png");
...
//		miniButtonBar.add(searchButton);
	...
	private void removeSelected()
	{
		...
		{
			LeafWalkUtil.recursiveRun(toRemoveNode.getUserObject(), new LeafRunnable<T>()
			{
				@Override
