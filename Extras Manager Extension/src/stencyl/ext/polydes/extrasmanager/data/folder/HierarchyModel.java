...
public class HierarchyModel<T extends Leaf<T>> implements LeafListener<T>, BranchListener<T>
{
	...
	public HierarchyModel(Branch<T> rootBranch)
	{
		...
		LeafWalkUtil.installListeners(rootBranch, this, this);
		...
		LeafWalkUtil.recursiveRun(rootBranch, new LeafRunnable<T>()
		{
			@Override
	...
	public void dispose()
	{
		LeafWalkUtil.uninstallListeners(rootBranch, this, this);
		leafNames.clear();
		rootBranch = null;
	}
...
//		System.out.println("Folder Item Added: " + folder + ", " + item);
		if(!simpleMove)
			LeafWalkUtil.installListeners(item, this, this);
...
//		System.out.println("Folder Item Removed: " + folder + ", " + item);
		if(!simpleMove)
			LeafWalkUtil.uninstallListeners(item, this, this);
